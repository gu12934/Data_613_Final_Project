...
# 5.1 Multi-Panel Feature Analysis (GGally)
...
# 5.2 Macroeconomic Correlations (GGally)
# Note: This requires joined_data to have enough variation to compute correlation
...
# 5.4 Inter-Correlation Pairs Plot (Segmented)
ggpairs(rent_clean, 
